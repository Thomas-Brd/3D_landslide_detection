...
workflow_folder = 'Analyse_stable_areas/Landslide_detection/'
# Data to use
Data_folder = 'LiDAR_Data/'
filenames = {'pre_EQ_lidar':'LiDAR_2014', 'post_EQ_lidar':'LiDAR_2016_registered', 'core_points': 'stable_area_core_points'} # filenames for the 3D M3C2
