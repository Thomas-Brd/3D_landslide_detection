...
workflow_folder = 'Analyse_signal_bruit_ratio/Subsampled_clouds/'
# Data to use
Data_folder = 'LiDAR_Data/'
filenames = {'pre_EQ_lidar':'subsample_cloud1', 'post_EQ_lidar':'subsample_cloud2', 'core_points': 'core_points'} # filenames for the 3D M3C2
